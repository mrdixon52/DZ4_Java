...
public class Task3 {
    public static void main(String[] args) {
        ...
        System.out.println(
                "Добро пожаловать в программу простого калькулятора 3.0!\nЗдесь вы можете произвести операции + , - , * или /\nЕсли ввести слово 'Отмена', то отменится последнее действие и вернется предыдущий результат "
                        + "или \nЕсли ввести слово 'Стоп', программа закроется");
        ...
        while (calc == true) {
            ...
            if (operation.equals("стоп")){
                System.out.println("Программа выключенна!");
                break;
            }
    ...
    public static String input_operation(Scanner scanner) {
        System.out.println("Введите оператор действия (+, -, *, /),'Отмена' или 'Стоп'");
    ...
    public static void reset_operation(Deque<Double> list) {
        if (!list.isEmpty()) {
            ...
            System.out.println("Работаем с данным результатом " + list.getLast());
        }
    }
